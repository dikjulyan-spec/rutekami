...
/** Wordmark "RuteTrip" + tagline "PLAN · JOURNEY · EXPLORE" versi SVG text (tiru logo gambar, tanpa file eksternal). */
export function BrandWordmark({ className }: { className?: string }) {
  return (
    <svg viewBox="0 0 320 92" width="320" height="92" fill="none" className={className} role="img" aria-label="RuteTrip — Plan · Journey · Explore">
      {/* Rute (navy) */}
      <text x="0" y="56" fontFamily="Plus Jakarta Sans, Inter, system-ui, sans-serif" fontSize="62" fontWeight="800" letterSpacing="-2.5" fill="#153E63">
        Rute<tspan fill="#0E9A96">Trip</tspan>
      </text>
      {/* tagline */}
      <text x="4" y="84" fontFamily="Plus Jakarta Sans, Inter, system-ui, sans-serif" fontSize="14.5" fontWeight="700" letterSpacing="3.2" fill="#0E9A96">
...
export function BrandLogo({ className }: { className?: string }) {  return (
